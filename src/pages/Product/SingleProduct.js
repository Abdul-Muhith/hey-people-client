...
const SingleProduct = () => {
  ...
  const props = { with: 400, height: 500, zoomWidth: 500, img: "https://media.istockphoto.com/id/1359180038/photo/wristwatch.webp?s=2048x2048&w=is&k=20&c=-z2ouAL6uyFVy9Qm4puO5MWTo8_eI3KiIcxTaFRsQnc=" };
  ...
  return (
    <>
      ...
      <div className='home-wrapper-2 py-5 main-product-wrapper'>
      ...
      <secion className='home-wrapper-2 py-5 description-wrapper'>
        <div className='container-xxl'>
          <div className='row'>
      ...
      <secion className='home-wrapper-2 reviews-wrapper'>
        <div className='container-xxl'>
          <div className='row'>
            <div className='col-12'>
